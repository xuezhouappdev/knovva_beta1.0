<?php
$pageTitle="Position - Teaching Assistant | Knovva Academy";
$position = "Teaching Assistant ";
$embed_url ="position_academic_6";
...
<!--position banner-->
<div class="position-banner" style="background: url('./img/position-teaching-assistant.jpg') center
...
<div class="breadcrumb-wrapper">
    <div class="container">
        <nav class="breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Teaching Assistant</a>
        </nav>
    </div>
</div>
...
<div class="job-description">
    <div class="container">
        ...
        <ul>
            <li>2+ years of supervising and facilitating youth (9th-12th grade).
            </li>
            <li>Bachelor’s degree</li>
            <li>Demonstrated interest in social studies education and civic engagement.
            </li>
        </ul>
