...
include 'header.php';
    ...
    $teacher_Becca = new Teacher("Rebecca Shuman","Becca completed her Ed.M in Prevention Science and Practice at the Harvard Graduate School of Education and her undergraduate studies at Eugene Lang College The New School for Liberal Arts. She has worked with children and adolescents in a variety of alternative educational settings to help them navigate and access tools to strengthen resilience and build a successful future. ","Educational Specialist","./img/portrait/portrait-becca");
